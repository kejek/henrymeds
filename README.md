...
8. ~~I believe that you can also create a reservation at the last available hour (ie, if the schedule range is from 1pm to 5pm, the client could request an appointment at 5pm). I would definitely not allow this!~~ Fixed, ignores the endDate for the 15 minute increments. May still allow you to try to reserve the last slot.
